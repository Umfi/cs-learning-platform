...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header"><a href="{{ route('admin') }}">Dashboard</a> / {{ __('Courses') }}</div>
                        ...
                        <table id="courseTable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if( $course->active )
                                            <form method="POST" action="{{ route('admin-deactivateCourse') }}">
                                                {{csrf_field()}}
                                        ...
                                        @else
                                            <form method="POST" action="{{ route('admin-activateCourse') }}">
                                                {{csrf_field()}}
                                                <input type="hidden" name="id" value="{{ $course->_id }}">
